...
#define DEVICE_UNLOCK_STATE		   5
#define DEVICE_LOCK_STATE 		  6
...
extern uint32_t stacklib_flash_data[];
extern uint8_t stacklib_stored_device_id_data[];
...
extern BlueNRG_Stack_Initialization_t BlueNRG_Stack_Init_params;
